...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',  options=[{'label': 'All Sites', 'value': 'ALL'},{'label': 'site1', 'value': 'CCAFS SLC 40'}, {'label': 'site2', 'value': 'KSC LC 39A'}],
...
def get_scatter_chart(entered_site, payload_range):
    if entered_site == 'ALL':
        # If all sites are selected, create scatter plot for all payloads
        ...
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Payload Success Rate for Site: {entered_site}')
